...
Register Here : [Koni Story](https://t.me/KoniStory_bot/app?startapp=s3ThUNFcp)

Join Script Channel:- [ A](https://t.me/+bnl8_wZ6Dfg0YmE0)
...
1. **Kloning repositori:**
   ```bash
   git clone https://github.com/CRYPTOMASTER09/KoniStory.git
   ```
   ```bash
   cd KoniStory
   ```
